 ...
 */
public class SomeCoDataRelater extends ExampleBase {
    ...
    public void relate() throws Exception {
        ...
        try {
	        ...
	        CMLCreateAssociation relatedDocAssoc = new CMLCreateAssociation(new Predicate(new Reference[]{docRefSource}, null, null),
					 ...
					 null,
					 Constants.createQNameString(SomeCoModel.NAMESPACE_SOMECO_CONTENT_MODEL, SomeCoModel.ASSN_RELATED_DOCUMENTS_STRING));
            ...
            dumpAssociations(docRefSource, Constants.createQNameString(SomeCoModel.NAMESPACE_SOMECO_CONTENT_MODEL, SomeCoModel.ASSN_RELATED_DOCUMENTS_STRING));
    ...
    public void dumpAssociations(Reference ref, String associationName) throws Exception {
        QueryResult assocQueryResult = WebServiceFactory.getRepositoryService().queryAssociated(ref, new Association(Constants.createQNameString(SomeCoModel.NAMESPACE_SOMECO_CONTENT_MODEL, SomeCoModel.ASSN_RELATED_DOCUMENTS_STRING), null));
