 ...
 */
public class SomeCoDataQueries extends ExampleBase {
    
    private static final String RESULT_SEP = "======================";
    private static final String USAGE = "java SomeCoDataCreator <username> <password> <folder path>";
    ...
    public void doExamples() {
    	...
    	try {
	    	...
	    	System.out.println("Finding content of type:" + SomeCoModel.TYPE_SC_DOC_STRING);
	    	queryString = "+TYPE:\"" + Constants.createQNameString(SomeCoModel.NAMESPACE_SOMECO_CONTENT_MODEL, SomeCoModel.TYPE_SC_DOC_STRING) + "\"";
	    	dumpQueryResults(getQueryResults(queryString));
	
	    	System.out.println("Find content in the " + getFolderPath() + " folder with text like 'sample'");
	    	queryString = "+PARENT:\"workspace://SpacesStore/" + getRootFolderUuid() + "\" +TEXT:\"sample\"";
	    	dumpQueryResults(getQueryResults(queryString));
	    	...
	    	System.out.println("Find active content with a client property containing 'Lebowski'");
			queryString = "+@sc\\:isActive:true +@sc\\:clientName:\"Lebowski\"";
			dumpQueryResults(getQueryResults(queryString));
			
			System.out.println("Find content of type sc:whitepaper published between 1/1/2006 and 6/1/2007");
			queryString = "+TYPE:\"" + Constants.createQNameString(SomeCoModel.NAMESPACE_SOMECO_CONTENT_MODEL, SomeCoModel.TYPE_SC_WHITEPAPER_STRING) + "\"" +
    ...
    public String getRootFolderUuid() throws Exception {

    	Reference reference = new Reference(getStoreRef(), null, getFolderPath());
